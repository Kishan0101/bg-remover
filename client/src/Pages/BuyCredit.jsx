...
const BuyCredit = () => {
  return (
    <div className='min-h-[100vh] text-center pt-14 mb-6'>
      <button className='px-10 py-2 mb-6 items-center border border-gray-400 rounded-full'>Our Plans</button>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
         {plans.map((item, index) => (
          <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-500 mb-8' key={index}>
